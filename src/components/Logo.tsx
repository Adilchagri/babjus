  ...
  return (
    <div className={`inline-flex flex-col items-center select-none cursor-pointer group ${className}`}>
      <div className="flex items-center gap-1 relative">
        ...
        >
          <svg width="34" height="28" viewBox="0 0 40 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <div className="flex items-baseline tracking-tight font-black text-2xl md:text-3xl drop-shadow-sm">
          <span 
      ...
      {showSubtitle && (
        <div className="flex flex-col items-center -mt-1 leading-none">
          ...
          <span className="text-[7.5px] font-bold tracking-[0.2em] text-babjus-yellow uppercase">
            EL JADIDA
          </span>
        </div>
      )}
